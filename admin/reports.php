...
<head>
    ...
    <title>Reports - ExamMaster Admin</title>
...
<body>
                ...
                <div class="col-12">
                    <div class="card report-card">
                        <div class="card-header bg-info text-white">
                            <h5 class="card-title mb-0">Registration Trend (Last 7 Days)</h5>
                        </div>
                        <div class="card-body">
                            <div class="chart-container">
    ...
    <script>
        ...
        new Chart(registrationTrendCtx, {
            type: 'line',
            data: {
                labels: <?php echo json_encode(array_column($registrationTrend, 'date')); ?>,
                datasets: [{
                    label: 'New Registrations',
                    data: <?php echo json_encode(array_column($registrationTrend, 'count')); ?>,
                    borderColor: '#4e73df',
                    tension: 0.1,
                    fill: false
                }]
